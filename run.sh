...
languages << Language.new("C", :compiled, "gcc -O3 -o fib fib.c", "./fib 46")
languages << Language.new("C++", :compiled, "g++ -O3 -o fib fib.cpp", "./fib 46")
languages << Language.new("Fortran", :compiled, "gfortran -O3 -o fib fib.f03", "./fib 46")
...
languages << Language.new("Swift", :compiled, "swiftc -O -g fib.swift", "./fib 46")
languages << Language.new("Crystal", :compiled, "crystal build --release fib.cr", "./fib 46")
...
languages << Language.new("Ruby", :interpreted, "", "ruby fib.rb 46")
